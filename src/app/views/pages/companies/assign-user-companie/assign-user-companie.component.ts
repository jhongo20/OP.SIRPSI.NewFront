...
@Component({
  selector: 'app-assign-user-companie',
  templateUrl: './assign-user-companie.component.html',
  styleUrls: ['./assign-user-companie.component.scss']
})
export class AssignUserCompanieComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<AssignUserCompanieComponent>,
  ...
  changeViewFormUser() {
    ...
    this.dialog
      .open(AssignUserCompanieComponent, {
        data: {
          id: 0,
          type: 0,
          reload: false,
