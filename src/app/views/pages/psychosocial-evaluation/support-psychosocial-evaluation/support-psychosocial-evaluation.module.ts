...
import { SupportPsychosocialEvaluationRoutingModule } from './support-psychosocial-evaluation-routing.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    SupportPsychosocialEvaluationRoutingModule,
    MatSnackBarModule,
    GenericTableModule,
    NgSelectModule,
    MatInputModule,
...
export class SupportPsychosocialEvaluationModule {}
